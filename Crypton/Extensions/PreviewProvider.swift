...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Markep Cap", value: "$12.5Bn", percentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "$123.5Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$1.5Tr", percentageChange: -25.34)
